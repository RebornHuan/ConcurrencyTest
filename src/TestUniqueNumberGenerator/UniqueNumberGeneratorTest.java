...
public class UniqueNumberGeneratorTest {
	  static final Log LOG = LogFactory.getLog(UniqueNumberGeneratorTest.class);
	  ...
	  public UniqueNumberGeneratorTest(String user, Dispatcher dispatcher,
	  ...
	  UniqueNumberGeneratorTest(String user, Dispatcher dispatcher,
